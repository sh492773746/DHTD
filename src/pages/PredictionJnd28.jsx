...
function PredictionJnd28() {
  ...
  const { data: predictions, loading: predictionsLoading, refetch: refetchPredictions } = usePredictions('jnd28');
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-indigo-50 p-4 pb-24">
        <div className="max-w-6xl mx-auto space-y-4">
          ...
          <Button 
            ...
            variant="ghost" 
            size="sm"
            className="mb-2 text-purple-600 hover:text-purple-700 hover:bg-purple-100"
          >
          ...
          {/* 顶部标题横幅 */}
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-purple-600 via-pink-600 to-indigo-600 p-6 text-white shadow-xl">
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-purple-100 text-sm">基于最新100条已验证数据的算法准确率统计</p>
                </div>
                <Button 
                ...
                return (
                  <Card
                    ...
                    className={`cursor-pointer transition-all hover:shadow-xl border-2 ${
                      isSelected ? 'ring-2 ring-offset-2 ring-purple-500 scale-105' : color.bg
                    }`}
