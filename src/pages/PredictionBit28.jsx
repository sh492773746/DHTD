...
function PredictionBit28() {
  ...
  const { data: algorithmPredictions, loading: predictionsLoading, refetch: refetchPredictions } = useAllAlgorithmPredictions('bit28', 20);
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm mt-1">Bitcoin 28 Prediction</p>
                  </div>
                </div>
